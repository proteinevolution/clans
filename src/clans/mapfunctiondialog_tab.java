...
public class mapfunctiondialog_tab extends javax.swing.JFrame {
    ...
    boolean loadmapfile(File mapfile){
        mapnode map=null;
        if((map=mapfunctionutils.loadunknownformat(mapfile))==null){
    ...
    boolean loadlookupfile(File lookupfile, int index){
        ...
        if(((Boolean)golist.get(index)).booleanValue()==false){
            ...
            mapfunctionutils.loadGOlookup(lookupfile,(mapnode)maplist.get(index));
            lookup=null;
            tabpane.setTitleAt(index,"M:"+((File)parent.mapfiles.get(index)).getName()+" L:"+((File)parent.lookupfiles.get(index)).getName());
        }
        return true;
    ...
    void searchtree(String querystring){
        ...
        if(selindex>-1){
            ...
            if(((Boolean)golist.get(selindex)).booleanValue()==false){
                tree=(javax.swing.JTree) treelist.get(selindex);
                pathlist.add((mapnode)maplist.get(selindex));
                ...
                if(selindex2>-1){
                    tree=(javax.swing.JTree) tmplist.get(selindex2);
                    pathlist.add(((mapnode)maplist.get(selindex)).child[selindex2]);
    ...
    void gettreepaths(ArrayList pathlist, ArrayList retlist, java.util.regex.Pattern query, boolean goterms){
        ...
        if(innode.child!=null){
            ...
            if(m.matches()){
                retlist.add(new javax.swing.tree.TreePath(((mapnode[])pathlist.toArray(new mapnode[0]))));
            }
    ...
    public class mapmodel implements TreeModel {
        ...
        public Object getChild(Object parent, int index) {
            return ((mapnode)parent).child[index];
        }
        ...
        public int getIndexOfChild(Object parent, Object child) {
            return ((mapnode)parent).haschild((mapnode)child);
        }
