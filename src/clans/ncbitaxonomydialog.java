...
/*
 * ncbitaxonomydialog.java
 *
 * Created on Aug 19, 2011, 10:48:11 AM
 */
...
public class ncbitaxonomydialog extends javax.swing.JFrame {
    ...
    private void calcbuttonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_calcbuttonActionPerformed
        ...
        if(seqnum<1){
            ...
            int size=java.lang.reflect.Array.getLength(ncarr);
    ...
    private void findtextfieldActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_findtextfieldActionPerformed
        ...
        if(nameshash.containsKey(taxname)==false){
            ...
            java.util.regex.Matcher mym=null;
            for(int i=java.lang.reflect.Array.getLength(tmpnames);--i>=0;){
        ...
        System.out.println("hashsize="+java.lang.reflect.Array.getLength(tmpvals));
        for(int i=java.lang.reflect.Array.getLength(tmpvals);--i>=0;){
            ...
            if(speclist.size()<1){
                ...
                for(int j=speclist.size();--j>=0;){
                    ...
                    if(nameshash.containsKey(alttax[j])){
                        ...
                        checkindex=java.lang.reflect.Array.getLength(checkarr)-1;
