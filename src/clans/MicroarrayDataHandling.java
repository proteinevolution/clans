...
public class MicroarrayDataHandling {
     ...
     * @return
     */
    static float getglobalrelstdev(Vector<MicroarrayDatapoint[]> datvec) {
     ...
     * @return
     */
    static Vector<MicroarrayDatapoint[]> getfoldchange(Vector<MicroarrayDatapoint[]> datvec, boolean useavg){
        int datnum=datvec.size();
     ...
     * @return
     */
    static Vector<MicroarrayDatapoint[]> readdata(Vector<Replicates> datavec) {
