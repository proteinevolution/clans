...
public class ClusterDetectionBootstrapping {
    ...
    static boolean bootstrapconvex(MinimalAttractionValue[] dataarr, Vector<SequenceCluster> clustervec, String clustermethod, int replicates,
    ...
    static boolean bootstraplinkage(MinimalAttractionValue[] dataarr, Vector<SequenceCluster> clustervec, String clustermethod,
    ...
    static boolean bootstrapnetwork(MinimalAttractionValue[] dataarr, Vector <SequenceCluster> clustervec, String clustermethod, int replicates, float remove, int minseqnum, boolean dooffset,boolean globalaverage, int elements,int maxrounds){
        //remove "remove" of data and then recluster for "replicates" replicates.
        //then get the cluster confidences AND sequence to cluster confidences
        Vector<SequenceCluster>[] replicate = new Vector[replicates];
        int attnum=dataarr.length;
