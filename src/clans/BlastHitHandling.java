...
public class BlastHitHandling {
    ...
    static HighScoringSegmentPair[] gethsps(int referenceseqnum,AminoAcidSequence[] inaln,String cmd,String formatdbpath,String blastpath,boolean addblastvbparam,String[] referencedb,double mineval,double minpval){
