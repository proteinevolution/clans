...
public class WindowSelectedsAndTheirMatches extends javax.swing.JFrame {
   ...
   /*
    ...
    static int[] getblasthits(MinimalAttractionValue[] myattvals,int[] selectednames,String[] parentnamesarr){
