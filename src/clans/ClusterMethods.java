...
public class ClusterMethods {
	 ...
	 */
	static void iterateOneRound(ClusterData data, boolean move_only_selected_sequences) {
	 ...
	 * @return
	 */
    static float computeSimpleAttractionValue(double[] invec,int dbsize,double minpval,ClusterData data){
	 ...
	 * @return
	 */
	static float computeComplexAttractionValue(double[] invec, int dbsize, double minpval, ClusterData data) {
	 ...
	 */
	static AminoAcidSequence[] removeGapsFromSequences(AminoAcidSequence[] sequences) {
