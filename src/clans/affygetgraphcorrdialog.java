...
public class affygetgraphcorrdialog extends javax.swing.JFrame {
    ...
    void getcorrelated(int corrmethod,boolean corranticorr,float mincorr,float[] vals){
        ...
        datapoint[] drawvals=new datapoint[count];
        datapoint[] currvals=new datapoint[count];
        count=0;
        for(int i=0;i<conditions;i++){
            if(vals[i]!=-1){
                drawvals[count]=new datapoint();
    ...
    float getcorrval(int corrmethod,datapoint[] vals, datapoint[] currvals){
    ...
    float spearman(datapoint[] indat1,datapoint[] indat2){
