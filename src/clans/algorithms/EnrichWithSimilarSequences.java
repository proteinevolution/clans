...
import clans.UnusedHspLikeThingPreviouslyCalledProghsp;
import clans.io.ThreadedStreamReader;
import clans.model.proteins.AminoAcidSequence;

public class EnrichWithSimilarSequences {
     ...
     * @return
     */
    public AminoAcidSequence[] enrich(AminoAcidSequence[] inseqs, String cmd, String blastpath, String formatdbpath,
    ...
    static AminoAcidSequence[] getsequences(String[] seqnames, String[] databases){
        ...
        HashMap<String, UnusedHspLikeThingPreviouslyCalledProghsp> seqnameshash=new HashMap<String, UnusedHspLikeThingPreviouslyCalledProghsp>((int)(seqnamesize/0.75),0.8f);
        UnusedHspLikeThingPreviouslyCalledProghsp spacer=new UnusedHspLikeThingPreviouslyCalledProghsp(); //placeholder
