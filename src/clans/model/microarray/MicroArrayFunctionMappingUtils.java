...
public class MicroArrayFunctionMappingUtils {
     ...
     * @return
     */
    public static HashMap<String, String> loadlookup(File loadfile){
     ...
     * @param rootnode
     */
    public static void loadGOlookup(File loadfile, MicroarrayMapnode rootnode){
        System.out.println("reading "+loadfile.getName());
     ...
     * @return
     */
    public static MicroarrayMapnode loadunknownformat(File loadfile) {
