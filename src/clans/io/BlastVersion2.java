...
public class BlastVersion2 {
    ...
    class blastthread extends java.lang.Thread {
        ...
        public void run() {
            ...
            errout = null;
            ArrayList<HighScoringSegmentPair> hsplist = HspReaderVersion2.get(tmpoutfile, eval, pval, coverage, scval, ident, verbose);
            if (hsplist == null) {
