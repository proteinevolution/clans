...
public class BlastHitHandling {
    
    public static HighScoringSegmentPair[] gethsps(int referenceseqnum,AminoAcidSequence[] inaln,String cmd,String formatdbpath,String blastpath,boolean addblastvbparam,String[] referencedb,double mineval,double minpval){
        //get all the blast hits to this sequence.
        Vector<HighScoringSegmentPair> retvec = new Vector<HighScoringSegmentPair>();
        ...
        HighScoringSegmentPair[] retarr=new HighScoringSegmentPair[retvec.size()];
