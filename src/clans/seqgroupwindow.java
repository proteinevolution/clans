...
public class seqgroupwindow extends javax.swing.JFrame {
    ...
    private void hidebuttonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_hidebuttonActionPerformed
        ...
        if((reference>-1) && (reference<=parent.data.seqgroupsvec.size())){
            boolean refbool=((seqgroup)parent.data.seqgroupsvec.elementAt(reference)).hide;
            if(refbool==true){
                refbool=false;
            }else{
                refbool=true;
            ...
            if(java.lang.reflect.Array.getLength(currsel)>0){
                ...
                for(i=java.lang.reflect.Array.getLength(currsel);--i>=0;){
                    if((currsel[i]>-1) && (currsel[i]<=parent.data.seqgroupsvec.size())){
                        ((seqgroup)parent.data.seqgroupsvec.elementAt(currsel[i])).hide=refbool;
                    }
                }//end for i
            }
        }
    ...
    private void sortselcolormenuitemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_sortselcolormenuitemActionPerformed
        ...
        if(java.lang.reflect.Array.getLength(currsel)>0){
            ...
            for(int i=java.lang.reflect.Array.getLength(currsel)-1;i>=0;i--){
                if((currsel[i]>-1) && (currsel[i]<=parent.data.seqgroupsvec.size())){
                    tmparr[i]=(seqgroup)parent.data.seqgroupsvec.elementAt(currsel[i]);
                }
            }//end for i
            //now sort tmparr
    ...
    private void sortcolormenuitemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_sortcolormenuitemActionPerformed
        ...
        for(int i=0;i<num;i++){
            tmparr[i]=(seqgroup)parent.data.seqgroupsvec.elementAt(i);
        }//end for i
        java.util.Arrays.sort(tmparr,new seqgroupscolorcomparator());
        for(int i=0;i<num;i++){
    ...
    private void groupcohesionmenuitemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_groupcohesionmenuitemActionPerformed
        ...
        if((currsel>-1) && (currsel<=parent.data.seqgroupsvec.size())){
            ...
            int[] sequences=((seqgroup)parent.data.seqgroupsvec.elementAt(currsel)).sequences;
            ...
            ((seqgroup)parent.data.seqgroupsvec.elementAt(currsel)).confvals="avg:"+avgval+" var:"+varval+" outavg:"+outavg+" outvar:"+outvar;
        }else{
            ...
            if(returnVal == javax.swing.JFileChooser.APPROVE_OPTION) {
                ...
                for(int i=java.lang.reflect.Array.getLength(currsel)-1;i>=0;i--){
                    if((currsel[i]>-1) && (currsel[i]<=parent.data.seqgroupsvec.size())){
                        ...
                        try{
                            java.io.PrintWriter outwrite=new java.io.PrintWriter(new java.io.BufferedWriter(new java.io.FileWriter(outfile)));
    ...
    private void largerbuttonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_largerbuttonActionPerformed
        ...
        if((reference>-1) && (reference<=parent.data.seqgroupsvec.size())){
            int refsize=((seqgroup)parent.data.seqgroupsvec.elementAt(reference)).size + 1;
            int[] currsel=groupslist.getSelectedIndices();
            if(java.lang.reflect.Array.getLength(currsel)>0){
                int i;
                for(i=java.lang.reflect.Array.getLength(currsel);--i>=0;){
                    if((currsel[i]>-1) && (currsel[i]<=parent.data.seqgroupsvec.size())){
                        ((seqgroup)parent.data.seqgroupsvec.elementAt(currsel[i])).size=refsize;
                        ((seqgroup)parent.data.seqgroupsvec.elementAt(currsel[i])).polygon=makepolygons.get(((seqgroup)parent.data.seqgroupsvec.elementAt(currsel[i])).type,((seqgroup)parent.data.seqgroupsvec.elementAt(currsel[i])).size);
                    }
                }//end for i
                largerbutton.setText("^ ("+(((seqgroup)parent.data.seqgroupsvec.elementAt(reference)).size+1)+")");
                smallerbutton.setText("v ("+(((seqgroup)parent.data.seqgroupsvec.elementAt(reference)).size-1)+")");
            }
        }
        repaint();
    ...
    private void typepanelMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_typepanelMouseClicked
        ...
        //int currsel=groupslist.getSelectedIndex();
        //if((currsel>-1) && (currsel<=parent.seqgroupsvec.size())){
        //    ((seqgroup)parent.seqgroupsvec.elementAt(currsel)).polygon=draw1.type;
        //}
        int[] currsel=groupslist.getSelectedIndices();
        if(java.lang.reflect.Array.getLength(currsel)>0){
            for(int i=java.lang.reflect.Array.getLength(currsel)-1;i>=0;i--){
                if((currsel[i]>-1) && (currsel[i]<=parent.data.seqgroupsvec.size())){
                    ((seqgroup)parent.data.seqgroupsvec.elementAt(currsel[i])).type=draw1.type;
                    ((seqgroup)parent.data.seqgroupsvec.elementAt(currsel[i])).polygon=makepolygons.get(draw1.type,((seqgroup)parent.data.seqgroupsvec.elementAt(currsel[i])).size);
                }
            }//end for i
        }
        repaint();
    ...
    private void setasselectedbuttonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_setasselectedbuttonActionPerformed
        ...
        if(java.lang.reflect.Array.getLength(currsel)>0){
            ...
            for(int i=java.lang.reflect.Array.getLength(currsel)-1;i>=0;i--){
                if((currsel[i]>-1) && (currsel[i]<=parent.data.seqgroupsvec.size())){
                    counter+=java.lang.reflect.Array.getLength(((seqgroup)parent.data.seqgroupsvec.elementAt(currsel[i])).sequences);
                }
            }
    ...
    private void groupslistValueChanged(javax.swing.event.ListSelectionEvent evt) {//GEN-FIRST:event_groupslistValueChanged
        ...
        int currsel=groupslist.getSelectedIndex();
        if(currsel>-1){
            colorbutton.setBackground(((seqgroup)parent.data.seqgroupsvec.elementAt(currsel)).color);
            draw1.type=((seqgroup)parent.data.seqgroupsvec.elementAt(currsel)).type;
            largerbutton.setText("^ ("+(((seqgroup)parent.data.seqgroupsvec.elementAt(currsel)).size+1)+")");
            smallerbutton.setText("v ("+(((seqgroup)parent.data.seqgroupsvec.elementAt(currsel)).size-1)+")");
            this.repaint();
            ...
            for(int i=java.lang.reflect.Array.getLength(currselarr)-1;i>=0;i--){
                if((currselarr[i]>-1) && (currselarr[i]<=parent.data.seqgroupsvec.size())){
                    counter+=java.lang.reflect.Array.getLength(((seqgroup)parent.data.seqgroupsvec.elementAt(currselarr[i])).sequences);
                }
            }
            int[] selecteds=new int[counter];
            counter=0;
            seqgroup mygroup;
            for(int i=java.lang.reflect.Array.getLength(currselarr)-1;i>=0;i--){
                mygroup=(seqgroup)parent.data.seqgroupsvec.elementAt(currselarr[i]);
                for(int j=java.lang.reflect.Array.getLength(mygroup.sequences)-1;j>=0;j--){
                    selecteds[counter]=mygroup.sequences[j];
                    counter++;
                }//end for j
            ...
            parent.groupseqscolor=((seqgroup)parent.data.seqgroupsvec.elementAt(currsel)).color;
            parent.repaint();
        }
    ...
    private void addbuttonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addbuttonActionPerformed
        ...
        if(java.lang.reflect.Array.getLength(parent.data.selectednames)==0){
            ...
            javax.swing.JOptionPane.showMessageDialog(this,"No sequences selected","Error", javax.swing.JOptionPane.ERROR_MESSAGE);
            return;
        }
    ...
    private void colorbuttonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_colorbuttonActionPerformed
        ...
        if(java.lang.reflect.Array.getLength(currsel)>0){
            if((currsel[0]>-1) && (currsel[0]<=parent.data.seqgroupsvec.size())){
                ...
                for(int i=java.lang.reflect.Array.getLength(currsel)-1;i>=0;i--){
                    ((seqgroup)parent.data.seqgroupsvec.elementAt(currsel[i])).color=newcolor;
                }
            }
            this.repaint();
            parent.groupseqscolor=((seqgroup)parent.data.seqgroupsvec.elementAt(currsel[0])).color;
            parent.repaint();
        }
    ...
    private void namebuttonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_namebuttonActionPerformed
        ...
        int currsel=groupslist.getSelectedIndex();
        if((currsel>-1) && (currsel<=parent.data.seqgroupsvec.size())){
            String newname=((seqgroup)parent.data.seqgroupsvec.elementAt(currsel)).name;
            newname=javax.swing.JOptionPane.showInputDialog(this,"Group name:",newname);
            ((seqgroup)parent.data.seqgroupsvec.elementAt(currsel)).name=newname;
            repaint();
        }
    ...
    class MyCellRenderer extends javax.swing.JLabel implements javax.swing.ListCellRenderer {
        ...
        boolean cellHasFocus)    // the list and the cell have the focus
        {
            ...
            String s = ((seqgroup)value).name;
            //if(((seqgroup)value).groupconf>=0){
            s+="("+java.lang.reflect.Array.getLength(((seqgroup)value).sequences)+")";
            
            if(((seqgroup)value).confvals!=null){
                s+=" (cohesion: "+((seqgroup)value).confvals+")";
            }
            if(((seqgroup)value).hide==true){
                s+=" (hidden)";
            }
            setText(s);
            if(colornamescheckbox.isSelected()){
                if (isSelected) {
                    ...
                    setForeground(((seqgroup)value).color);
                }
                else {
